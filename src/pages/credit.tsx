            ...
            <section className='h-screen mt-24'>
                  <div className='text-center'>
                        ...
                        <div className='flex justify-center py-4 gap-8'>
                              <Link href='https://github.com/oferGavrilov' aria-label='Move to Github profile' target='_blank'><SiGithub className='footer-icon text-4xl' /></Link>
                              <Link href='https://www.linkedin.com/in/ofergavriel/' aria-label='Move to Linkedin profile' target='_blank'><SiLinkedin className='footer-icon text-4xl' /></Link>
                              <Link href='https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=ofergavri@gmail.com' aria-label='Move to Gmail' target='_blank'><SiGmail  className='footer-icon text-4xl' /></Link>
                        </div>
                  </div>
            </section>
      )
